// mostly copied from https://github.com/microsoft/vscode/blob/1.101.2/src/vs/workbench/services/textMate/common/TMGrammarFactory.ts
...
const missingTMGrammarErrorMessage =
  'No TM Grammar registered for this language.'

export class TMGrammarFactory {
  ...
  constructor(
    ...
    this._grammarRegistry = new vscodeTextmate.Registry({
      ...
      loadGrammar: async (scopeName: string) => {
        ...
        try {
          const content = await vscode.workspace.fs.readFile(location)
